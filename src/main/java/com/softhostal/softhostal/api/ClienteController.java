...
import com.softhostal.softhostal.models.Cliente;
import com.softhostal.softhostal.repositories.ClienteRepository;
...
public class ClienteController {
    ...
    public ResponseEntity<Cliente> create(@RequestBody Cliente entidad) {
        try {
            Cliente _entidad = repository.save(new Cliente(null, entidad.getNombres(), entidad.getApellidos(), entidad.getDni(),entidad.getNumerotelefonico()));
